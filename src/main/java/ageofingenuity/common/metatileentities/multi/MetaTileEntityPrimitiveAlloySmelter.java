...
public class MetaTileEntityPrimitiveAlloySmelter extends RecipeMapPrimitiveMultiblockController {
    ...
    public MetaTileEntityPrimitiveAlloySmelter(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, AOIRecipeMaps.PRIMITIVE_ALLOY_SMELTER_RECIPES);
    }
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .aisle("AAA", "C&C", "C#C")
                .aisle("AAA", "CSC", "CCC")
                .where('A', states(AOIBlocks.REFRACTORY_CEMENT.getDefaultState()))
                .where('C', states(AOIBlocks.REFRACTORY_CEMENT_BRICKS.getDefaultState()))
                .where('#', air())
